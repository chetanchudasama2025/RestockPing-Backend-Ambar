...
INSERT INTO users (email, name, role) VALUES 
    ('alice.owner@company.com', 'Alice Johnson', 'owner'),
    ('bob.team@company.com', 'Bob Smith', 'team'),
    ('carol.manager@company.com', 'Carol Davis', 'owner'),
    ('david.engineer@company.com', 'David Wilson', 'team'),
